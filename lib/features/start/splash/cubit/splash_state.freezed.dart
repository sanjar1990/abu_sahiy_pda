...
class _$SplashBuildableImpl implements _SplashBuildable {
  const _$SplashBuildableImpl({this.onBoarded = false});
  ...
  @override
  String toString() {
    return 'SplashBuildable(onBoarded: $onBoarded)';
  }
...
abstract class _SplashBuildable implements SplashBuildable {
  const factory _SplashBuildable({final bool onBoarded}) =
      _$SplashBuildableImpl;
